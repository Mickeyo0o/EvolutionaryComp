...
IntraNodeChangeEdgeNeighbourhoodMove::IntraNodeChangeEdgeNeighbourhoodMove(unsigned int cyclePos1EdgeStart, unsigned int cyclePos2EdgeStart):
...
int IntraNodeChangeEdgeNeighbourhoodMove::calculateFunctionDelta(const CostDistanceInfo* costDistanceInfo, const std::vector<int>& currentCycle)
{
...
void IntraNodeChangeEdgeNeighbourhoodMove::performMove(std::vector<int>& currentCycle)
{
...
std::vector<NeighbourhoodMove*> IntraNodeChangeEdgeNeighbourhoodMove::generateAllMoves(const std::vector<int>& currentCycle, const CostDistanceInfo* costDistanceInfo)
{
    ...
    for(int posInCycle1 = 0; posInCycle1 < currentCycle.size() - 3; posInCycle1++)
    {
        ...
        {
            ret.push_back(new IntraNodeChangeEdgeNeighbourhoodMove(posInCycle1, posInCycle2));
        }
    }
