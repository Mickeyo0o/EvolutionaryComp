...
bool IntraNodeChangeEdgeNeighbourhoodMoveLocalSearch::isApplicable(const std::vector<int>& currentCycle, int* cyclePosCache)
{
    return true;
}

bool IntraNodeChangeEdgeNeighbourhoodMoveLocalSearch::shouldBeLeftInLM(const std::vector<int>& currentCycle, int* cyclePosCache)
{
    return true; //Unused
}

std::vector<int> IntraNodeChangeEdgeNeighbourhoodMoveLocalSearch::getEnteringIds()
{
    return std::vector<int>{};
}


bool IntraNodeChangeEdgeNeighbourhoodMoveLocalSearch::equals(const NeighbourhoodMove& other)
{
    return true; //Unused
}
